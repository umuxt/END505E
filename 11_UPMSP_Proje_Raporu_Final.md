...
**Zaman-Tetiklemeli ($t_s$) Geçiş:** Makalenin asıl gücü, bu kuralları statik bırakmamasıdır. Belirli bir zamana ($t_s$) kadar kural A, o zamandan sonra kural B çalıştırılarak melez (hybrid) stratejiler üretilir. Toplam 39 konfigürasyon, bu esneklik sayesinde farklı talep senaryolarına adapte olabilir.
...
1.  **Pozitif İdeal Çözüm ($S^+$):** Üç hedefin (Cmax, T, L) en iyi değerlerini içeren hayali nokta.
